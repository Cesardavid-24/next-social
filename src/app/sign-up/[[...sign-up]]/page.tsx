        ...
        <div className="relative md:flex-1 bg-gradient-to-br from-blue-600 to-indigo-800 p-4 sm:p-6 md:p-10 lg:p-16 flex flex-col justify-between overflow-hidden text-white">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between gap-4 mb-4 md:mb-12">
              ...
              <Link href="/sign-in" className="md:hidden bg-white/20 hover:bg-white/30 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-colors border border-white/30 backdrop-blur-sm whitespace-nowrap">
                Entrar
              </Link>
            </div>
