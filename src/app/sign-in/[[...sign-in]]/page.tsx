  ...
  return (
    <div className="min-h-[calc(100vh-96px)] w-full flex items-center justify-center p-4 lg:p-8">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-6xl bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-gray-100">
        ...
        <div className="relative flex-1 bg-gradient-to-br from-blue-600 to-indigo-800 p-10 lg:p-16 flex flex-col justify-between overflow-hidden text-white">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-12">
              <div className="bg-white p-2 rounded-xl shadow-sm flex items-center justify-center">
                <Image src="/logo-unefa.png" alt="Logo Unefa" width={48} height={48} className="object-contain" />
              </div>
              <h1 className="text-2xl font-bold tracking-wide">SomosUnefaEE</h1>
            </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-10 lg:p-16 bg-gray-50 relative">
          <div className="w-full max-w-md">
            <div className="text-center mb-8 md:hidden">
              <h2 className="text-3xl font-bold text-gray-800 mb-2">Iniciar Sesión</h2>
              <p className="text-gray-500">Ingresa para continuar a SomosUnefaEE</p>
            </div>
